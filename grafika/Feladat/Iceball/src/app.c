...
//itt is scene.iceball volt
        ...
        case SDL_KEYUP:
            ...
            case SDL_SCANCODE_J:
            case SDL_SCANCODE_L:
                setting_iceball_moving_speed(&(app->scene.iceball), 0.0);
                setting_iceball_rotation(&(app->scene.iceball), 0.0); 
                break;
...
void update_app(App* app)
{
    ...
    update_scene(&(app->scene)); // update scene 
}
